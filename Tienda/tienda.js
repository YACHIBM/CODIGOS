var productos=["GANSITO","DONITAS","LECHITA","PRINGLES","VITALOE","PEPSI","VOLT","KINDER"];
var precios=[18, 26, 15, 28, 15,18,22,27];
...
const imprimirTabla=()=>{
    ...
    let tablaHTML=`<table class="table w-100 m-auto table-striped table-info table-bordered border-info">
        <tr>
 ...
 <td><button class="btn btn-danger" onclick="eliminarCarrito(${index})"><i class="bi bi-trash m-2"></i></button></td> 
            </tr>
            `
            index++;
...
const verProductos = () => {
 ...
 <td><button class="btn btn-danger" onclick="eliminarCarrito2(${index})"><i class="bi bi-trash m-2"></i></button></td> 
            </tr>
            `
            index++;
            total+=(precios[item[0]]*item[1]);
